...
const BOOKS: Book[] = [
{
  ...
  spineColor: '#7B241C',
  content:
  'Sejarah kraf bermula daripada keperluan manusia untuk menghasilkan barangan yang mempunyai fungsi praktikal dalam kehidupan seharian. Perkembangannya dipengaruhi oleh persekitaran, sumber bahan, kemahiran dan kreativiti masyarakat setempat. Dari masa ke masa, aktiviti menghasilkan kraf berkembang daripada sekadar memenuhi keperluan kepada satu bentuk ekspresi seni yang mempunyai nilai estetika, simbolik dan budaya. Di Malaysia, pelbagai kraf tradisional seperti anyaman, batik, songket, tembikar dan ukiran kayu berkembang sebagai sebahagian daripada warisan masyarakat yang diwarisi dari satu generasi kepada generasi seterusnya.',
  imageUrl: 'https://img.rocket.new/generatedImages/rocket_gen_img_10cd37f00-1778848735795.png',
  imageAlt: 'Traditional Malaysian batik fabric with intricate hand-drawn patterns in warm earthy tones'
},
{
  id: 'budaya',
  title: 'Hubungan Kraf dengan Budaya',
  color: '#1A5276',
  colorDark: '#154360',
  colorLight: '#D6EAF8',
  spineColor: '#0E3460',
  content:
  'Kraf mempunyai hubungan yang erat dengan budaya kerana penghasilannya mencerminkan identiti, adat, kepercayaan dan warisan sesebuah masyarakat. Motif, corak, bahan dan teknik yang digunakan sering mempunyai makna serta nilai simbolik tertentu. Oleh itu, kraf bukan sekadar hasil buatan tangan, tetapi menjadi medium untuk memelihara dan menyampaikan warisan budaya kepada generasi akan datang.',
  imageUrl: 'https://img.rocket.new/generatedImages/rocket_gen_img_109ae10c2-1775226882459.png',
  imageAlt: 'Colourful traditional Malaysian songket weaving with gold thread patterns on a loom'
},
{
  id: 'fungsi',
  title: 'Hubungan Kraf dengan Fungsi',
  color: '#B7770D',
  colorDark: '#9A6A0A',
  colorLight: '#FDEBD0',
  spineColor: '#7D5A08',
  content:
  'Kraf turut mempunyai hubungan yang rapat dengan fungsi kerana kebanyakan hasil kraf pada asalnya dihasilkan untuk memenuhi keperluan kehidupan. Sesebuah kraf boleh berfungsi sebagai peralatan, perhiasan, pakaian, bekas penyimpanan atau bahan hiasan. Perkembangan kraf kemudiannya menjadikan aspek fungsi digabungkan dengan nilai estetika, menjadikan sesuatu hasil bukan sahaja berguna tetapi turut mempunyai nilai keindahan.',
  imageUrl: 'https://img.rocket.new/generatedImages/rocket_gen_img_1306c9601-1764753287757.png',
  imageAlt: 'Handcrafted traditional clay pottery vessels and baskets arranged on a wooden surface'
},
{
  id: 'kreativiti',
  title: 'Hubungan Kraf dengan Kreativiti',
  color: '#1E8449',
  colorDark: '#196F3D',
  colorLight: '#D5F5E3',
  spineColor: '#145A32',
  content:
  'Kreativiti menjadi asas penting dalam penghasilan kraf melalui proses penerokaan idea, bahan, bentuk, warna dan teknik. Pengkarya menggunakan kreativiti untuk menghasilkan reka bentuk yang baharu tanpa menghilangkan ciri serta identiti kraf yang diwarisi. Proses ini membolehkan kraf terus berkembang mengikut perubahan zaman dan keperluan masyarakat, di samping mengekalkan nilai tradisi yang menjadi asasnya.',
  imageUrl: "https://img.rocket.new/generatedImages/rocket_gen_img_40778718b-1789593840239.png",
  imageAlt: 'Artist hands weaving colourful threads and experimenting with creative craft designs'
},
{
  id: 'jenis',
  title: 'Jenis Kraf',
  ...
  spineColor: '#4A235A',
  content:
  'Bidang kraf merangkumi pelbagai bentuk penghasilan karya melalui penerokaan bahan, teknik dan proses kerja artistik. Antara jenis kraf yang diterokai ialah:\n\n1. Topeng\n2. Boneka\n3. Origami\n4. Model\n5. Diorama',
  imageUrl: 'https://img.rocket.new/generatedImages/rocket_gen_img_1fb2e2e80-1769498617900.png',
  imageAlt: 'Various traditional craft types including masks, puppets, origami and model making displayed together'
}];


type Phase = 'flying' | 'arranged' | 'opening' | 'open';

export default function KrafBukuPage() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden select-none" style={{ background: '#5C3A1E' }}>
      ...
      {/* ── TITLE: just "Kraf" centered and large ── */}
      {!bookIsOpen &&
      <div
      ...
      <div
        ...
        {/* When a book is open, show the full-screen overlay */}
          ...
          style={{
            ...
            style={{
              ...
              style={{
                ...
                <div style={{
                position: 'absolute', top: 10, left: 16, width: 24, height: 24,
                border: '2px solid rgba(255,255,255,0.25)', borderRadius: 2
              }} />
                <div style={{
                position: 'absolute', bottom: 10, right: 20, width: 24, height: 24,
        ...
        <div
          ...
          style={{ width: '100%', maxWidth: 960, padding: '0 20px' }}>
            ...
            // Cute sticky note colors per book
            const stickyColors = [
            ...
            // Slight rotation per note for a scattered look
      ...
      <button
        onClick={() => {
          ...
          setTimeout(() => {
            setBtnPressed(false);
            window.location.href = '/projects/kraf/buku/kad';
          }, 320);
        }}
